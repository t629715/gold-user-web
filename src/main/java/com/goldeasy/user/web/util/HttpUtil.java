package com.goldeasy.user.web.util;
...
/**
 * @author:tianliya
 * @CreateTime:2018-01-08 16:23
 * @Description:获取请求相关的一些信息
 **/
public class HttpUtil {
    private static final String IGNORE_CASE = "unKnown";
    /** Wap网关Via头信息中特有的描述信息 , 中兴提供的wap网关的via信息，例如：Via=ZXWAP */
    private static String[] mobileGateWayHeaders = new String[] { "ZXWAP",
            // GateWayZTE
            // Technologies，
            // 中国移动的诺基亚wap网关，例如：Via=WTP/1.1
            "chinamobile.com",
            // GDSZ-PB-GW003-WAP07.gd.chinamobile.com (Nokia
            // WAP Gateway 4.1 CD1/ECD13_D/4.1.04)
            // 移动梦网的网关，例如：Via=WTP/1.1
            "monternet.com",
            // BJBJ-PS-WAP1-GW08.bj1.monternet.com. (Nokia WAP
            // Gateway 4.1 CD1/ECD13_E/4.1.05)
            "infoX",
            // 华为提供的wap网关，例如：Via=HTTP/1.1 GDGZ-PS-GW011-WAP2 (infoX-WISG
            ...
            // 自己测试时模拟的头信息
            "wap.lizongbo.com",
            // 貌似是一个给移动互联网提供解决方案提高网络运行效率的，例如：Via=1.1 Bytemobile OSN
            "Bytemobile",
            // WebProxy/5.1
    };
    ...
    private static String[] mobileUserAgents = new String[] {
            // 诺基亚，有山寨机也写这个的，总还算是手机，Mozilla/5.0
            // (Nokia5800
            // XpressMusic)UC
            // AppleWebkit(like
            // Gecko)
            ...
            "iPad",
            // iPad的ua，Mozilla/5.0 (iPad; U; CPU OS 3_2 like Mac OS X;
            // zh-cn) AppleWebKit/531.21.10 (KHTML like Gecko)
            // Version/4.0.4 Mobile/7B367 Safari/531.21.10
            "Android",
            // Android是否也转wap？Mozilla/5.0 (Linux; U; Android
            ...
            "UCWEB",
            // ucweb是否只给wap页面？ Nokia5800
            // XpressMusic/UCWEB7.5.0.66/50/999
            "ucweb",
            // 小写的ucweb貌似是uc的代理服务器Mozilla/6.0 (compatible; MSIE 6.0;)
            // Opera ucweb-squid
            "BREW",
            // 很奇怪的ua，例如：REW-Applet/0x20068888 (BREW/3.1.5.20; DeviceId:
            ...
            "K-Touch",
            // 还是天语K-Touch_N2200_CMCC/TBG110022_1223_V0801 MTK/6223
            // Release/30.07.2008 Browser/WAP2.0
            "Haier",
            // 海尔手机，Haier-HG-M217_CMCC/3.0 Release/12.1.2007
            // Browser/WAP2.0
            "DOPOD",
            // 多普达手机
            "Lenovo",
            // 联想手机，Lenovo-P650WG/S100 LMP/LML Release/2010.02.22
            ...
            // 含义不明
            "CMCC",
            // 移动定制手机，K-Touch_N2200_CMCC/TBG110022_1223_V0801 MTK/6223
            // Release/30.07.2008 Browser/WAP2.0
            "DAXIAN",
            // 大显手机DAXIAN X180 UP.Browser/6.2.3.2(GUI) MMP/2.0
            "MOT-",
            // 摩托罗拉，MOT-MOTOROKRE6/1.0 LinuxOS/2.4.20 Release/8.4.2006
            // Browser/Opera8.00 Profile/MIDP2.0 Configuration/CLDC1.1
            // Software/R533_G_11.10.54R
            "SonyEricsson",
            // 索爱手机，SonyEricssonP990i/R100 Mozilla/4.0
            ...
            // 华为手机，
            "webOS",
            // palm手机，Mozilla/5.0 (webOS/1.4.5; U; zh-CN)
            // AppleWebKit/532.2 (KHTML like Gecko) Version/1.0
            // Safari/532.2 Pre/1.0
            "GoBrowser",
            // 3g GoBrowser.User-Agent=Nokia5230/GoBrowser/2.0.290
            // Safari
            "IEMobile",
            // Windows CE手机自带浏览器，
            "WAP2.0"
    ...
    public static HttpEntity<Object> getHttpEntity(Object object){
        ...
        return new HttpEntity<Object>(object, requestHeaders);
    }
    /**
     * @CreateBy：tianliya
     * @CreateTime：2018/1/8 15:57
     * @Description：获取用户的额IP
     * @param request
     * @return
     */
    public static String getIp(HttpServletRequest request) {
        String ip = request.getHeader("X-Forwarded-For");
        if (StringUtils.isNotEmpty(ip) && !IGNORE_CASE.equalsIgnoreCase(ip)) {
    ...
    /**
     * @CreateBy：tianliya
     * @CreateTime：2018/1/8 16:01
     * @Description：获取注册信息
     * @param request
     * @return
     */
    public static String getDevice(HttpServletRequest request) {
        return HttpUtil.device(request);
    }

    /**
     * @CreateBy：tianliya
     * @CreateTime：2018/1/8 16:06
     * @Description：获取登录方式
     * @param request
     * @return
     */
    public static String getLoginWay(HttpServletRequest request) {
        Boolean b = HttpUtil.isMobileDevice(request);
        if (b.equals(true)) {
            return "手机";
        } else {
            return "电脑";
